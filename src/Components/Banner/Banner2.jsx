...
const Banner2 = () => {
  return (
    <section
      className="jm-banner-area-2 banner-hieght bg-default jm-overlay h-jobmot-banner-2"
      style={{
        backgroundImage: 'url(https://www.njstatefilmfestival.com/wp-content/uploads/2022/12/how-to-audition-for-a-movie-3-1024x683.jpeg)',
          ...
          <div className="col-12">
            <div className="jm-banner-content-static">
              <div className="jm-banner-content-haed text-center">
                ...
                <p>
                  There are many variations of passages of Lorem Ipsum Fasts <br />
                  by injected humour, or randomised words which...
                </p>
                <Link to="/jobListPage" className="jm-banner-layout-2-btn mt-25">
